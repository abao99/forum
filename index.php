...
<table width="50%" border="1" align="center">
  <tr>
    <td align="left" valign="middle">主題</td>
    <td align="left" valign="middle">發表人</td>
    <td align="left" valign="middle">時間</td>
  </tr>
  <?php do { ?>
    <tr>
      <td align="left" valign="middle"><a href="topic.php?TopicID=<?php echo $row_Recordset1['TopicID']; ?>"><?php echo $row_Recordset1['Title']; ?></a></td>
      <td align="left" valign="middle"><?php echo $row_Recordset1['Nickname']; ?></td>
      <td align="left" valign="middle"><?php echo $row_Recordset1['time']; ?></td>
    </tr>
